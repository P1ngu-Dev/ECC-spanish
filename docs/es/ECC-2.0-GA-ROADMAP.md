# Hoja de ruta GA de ECC 2.0

Esta hoja de ruta es el espejo duradero del repositorio para el proyecto activo de Linear:

<https://linear.app/itomarkets/project/ecc-platform-roadmap-52b328ee03e1>

La creación de incidencias en Linear ya está disponible de nuevo en el espacio de trabajo de Ito Markets. La verdad operativa en vivo se divide entre:
...
El mapa de ejecución de lanzamiento/crecimiento del 19 de mayo vive en
...
Es la superficie operativa para la identidad final del repositorio ECC 2.0, la suite de video, el embudo de socios/patrocinadores, el embudo de consultoría/charlas y el plan de lanzamiento social.
...
- Copy should avoid presenting this as a repo rename or config-pack migration.
  La prueba del lanzamiento debe show the system through install flow, cross-harness
...
## Lista de verificación de ejecución de prompt a artefacto
...
| Prompt requirement | Required artifact or gate | Actual evidence | Status |
| --- | --- | --- | --- |
| Keep public PRs below 20 | Repo-family PR recheck | 0 open PRs across `ECC`, AgentShield, JARVIS, `ECC-Tools/ECC-Tools`, and `ECC-Tools/ECC-website` on the late 2026-05-19 platform audit after merging ECC PR #2013, ECC-Tools PR #79, JARVIS PR #15, and JARVIS PR #16 | Completo |
| Keep public issues below 20 | Repo-family issue recheck | 0 open issues across `ECC`, AgentShield, JARVIS, `ECC-Tools/ECC-Tools`, and `ECC-Tools/ECC-website` on 2026-05-19 after the live platform audit refresh | Completo |
...
1. Actual public PR and issue counts.
...
### 1. Lanzamiento GA, nomenclatura y preparación para publicación del plugin
...
### 2. Matriz de cumplimiento de adaptadores del harness y punto de entrada al scorecard
...
### 3. Observabilidad local, HUD/estado y plano de control de sesión
...
### 4. Ciclo de evaluación del harness auto-mejorable
...
### 5. Plataforma de seguridad empresarial AgentShield
...
### 6. Facturación de ECC Tools, análisis profundo, verificaciones de PR y sincronización con Linear
...
### 7. Auditoría heredada y cierre de rescate de trabajo obsoleto

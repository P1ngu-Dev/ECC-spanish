# Lista de prompts del mega plan por repositorio — 12 de marzo de 2026

## Propósito

Usa estos prompts para dividir el trabajo pendiente del mega plan del 11 de marzo por repositorio.
Están escritos para agentes en paralelo y asumen que la orquestación del 12 de marzo y la línea
de CI de Windows ya se fusionaron mediante `#417`.

## Estado actual

- `everything-claude-code` ya completó la orquestación, la línea base de Codex y la recuperación
  de la CI de Windows.
- Los siguientes elementos abiertos de la Fase 1 de ECC son:
  - revisar `#399`
  - convertir la presión de discusiones recurrentes en issues rastreables
  - definir la arquitectura de instalación selectiva
  - escribir el documento de descubrimiento de ECC 2.0
- `agentshield`, `ECC-website` y `skill-creator-app` tienen worktrees sucios en `main` y no deben
  editarse directamente en `main`.
- `applications/` no es un repositorio git independiente. Vive dentro del repositorio del workspace
  padre en `<ECC_ROOT>`.

## Repo: `everything-claude-code`

### Prompt A — Revisión de PR `#399` y preparación para merge
...
### Prompt B — Extracción de issues de la hoja de ruta
...
### Prompt C — Descubrimiento de ECC 2.0 y especificación de adaptadores
...
### Prompt — Auditoría de falsos positivos y plan de regresión
...
### Prompt — Reescritura de landing y enfoque de producto
...
### Prompt — Pipeline de importación de skills y ajuste de producto
...
### Prompt — Aplicaciones de ejemplo y pruebas de confiabilidad del flujo de trabajo
...
El worktree actual debe mantenerse en trabajo nativo de ECC de la Fase 1 que no
toque los cambios existentes del archivo de habilidades sucio aquí. Las mejores
tareas locales siguientes son:

1. arquitectura de instalación selectiva
2. documento de descubrimiento de ECC 2.0
3. revisión del PR `#399`
